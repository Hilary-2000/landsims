        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src="assets/img/student.svg" class="img-fluid" alt="">
                </div>
            </div>
        </div>
        ...
        <section id="values" class="values">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h2>Our Values</h2>
                    <p>Values are like fingerprints, Nobody`s are the same.</p>
                </header>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                        <div class="box">
                            ...
                            <p>Accepting responsibility for your actions (and inactions) is the ultimate way to build trust internally and externally. And I believe we as a company will hold accountable to what we do and offer.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                        <div class="box">
                            ...
                            <h3>Passionate</h3>
                            <p>Having a joy not just for the work itself but also the people (clients, employees) around us, so that everyone can be bold, innovative, and creative. </p>
                        </div>
                    </div>
